...
describe('Service Tests', () => {
    ...
    describe('SocialmediaDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SocialmediaDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/socialmedia-details';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SocialmediaDetails', () => {
