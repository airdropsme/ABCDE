...
describe('Service Tests', () => {
    ...
    describe('CampaignParticipant Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CampaignParticipantService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/campaign-participants';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CampaignParticipant', () => {
